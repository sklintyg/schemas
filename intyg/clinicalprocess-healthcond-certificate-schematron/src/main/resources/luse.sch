...
<iso:schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:iso="http://purl.oclc.org/dsdl/schematron"
  ...
  <iso:title>Schematron file for "Läkarutlåtande för sjukersättning".</iso:title>
  ...
  <iso:pattern id="intyg">
    <iso:rule context="//rg:intyg">
      ...
      <iso:assert test="count(gn:svar[@id='4']) le 3">
        Ett 'MU' måste ha mellan 0 och 3 'Ange medicinska utredningar eller underlag'
      </iso:assert>
      ...
      <iso:let name="svarsIdExpr" value="'^([123456789]|1[01234789]|2[012356]|45|9[0-9]{3})$'"/>
