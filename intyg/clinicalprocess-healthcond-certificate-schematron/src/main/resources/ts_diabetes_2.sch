...
<iso:schema
  ...
  <iso:pattern id="intyg">
    <iso:rule context="//rg:intyg">
      <iso:let name="intyg" value="Ett 'MU'"/>
      <iso:assert test="count(gn:svar[@id='1']) ge 1 and count(gn:svar[@id='1']) le 16">
        <value-of select="$intyg"/> måste ha mellan 1 och 16 'Intyget avser behörighet'
      </iso:assert>
      <iso:assert test="count(gn:svar[@id='2']) = 1">
        <value-of select="$intyg"/> måste ha en 'Identitet styrkt genom'
      </iso:assert>
      <iso:assert test="count(gn:svar[@id='35']) = 1">
        <value-of select="$intyg"/> måste ha en 'År då diabetesdiagnosen ställdes'
      </iso:assert>
      <iso:assert test="count(gn:svar[@id='18']) le 1">
        <value-of select="$intyg"/> får ha högst ett 'Typ av diabetes'
      </iso:assert>
      <iso:assert test="count(gn:svar[@id='109']) le 1">
        <value-of select="$intyg"/> får ha högst ett 'Behandling för diabetes'
      </iso:assert>
      <iso:assert test="count(gn:svar[@id='100']) le 1">
        <value-of select="$intyg"/> får ha högst ett 'Diabetessjukdomen är under kontroll avseende hypoglykemi'
      </iso:assert>
      <iso:assert test="count(gn:svar[@id='37']) le 1">
        <value-of select="$intyg"/> får ha högst ett 'Förekomst av hypoglykemier med tecken på nedsatt hjärnfunktion som kan innebära en trafiksäkerhetsrisk '
      </iso:assert>
      <iso:assert test="count(gn:svar[@id='101']) le 1">
        <value-of select="$intyg"/> får ha högst ett 'Förstår risker förknippade med hypoglykemi'
      </iso:assert>
      <iso:assert test="count(gn:svar[@id='102']) le 1">
        <value-of select="$intyg"/> får ha högst ett 'Är väl förtrogen med symptomen på hypoglykemi'
      </iso:assert>
      <iso:assert test="count(gn:svar[@id='38']) le 1">
        <value-of select="$intyg"/> får ha högst ett 'Saknar förmåga att känna varningstecken'
      </iso:assert>
      <iso:assert test="count(gn:svar[@id='36']) le 1">
        <value-of select="$intyg"/> får ha högst ett 'Kunskap om lämpliga åtgärder vid hypoglykemi'
      </iso:assert>
      <iso:assert test="count(gn:svar[@id='105']) le 1">
        <value-of select="$intyg"/> får ha högst ett 'Egenkontroller av blodsocker'
      </iso:assert>
      <iso:assert test="count(gn:svar[@id='106']) le 1">
        <value-of select="$intyg"/> får ha högst ett 'Allvarlig återkommande hypoglykemi under det senaste året'
      </iso:assert>
      <iso:assert test="count(gn:svar[@id='107']) le 1">
        <value-of select="$intyg"/> får ha högst ett 'Allvarlig återkommande hypoglykemi i vaket tillstånd under de senaste tre månaderna'
      </iso:assert>
      <iso:assert test="count(gn:svar[@id='108']) le 1">
        <value-of select="$intyg"/> får ha högst ett 'Allvarlig hypoglykemi i trafiken under det senaste året'
      </iso:assert>
      <iso:assert test="count(gn:svar[@id='103']) = 1">
        <value-of select="$intyg"/> måste ha ett 'Proliferativ retinopati, genomgången laserbehandling av retinopati,
      ...
      <iso:assert test="count(gn:svar[@id='104']) = 1">
        <value-of select="$intyg"/> måste ha ett 'Ögonbottenfoto saknas'
      </iso:assert>
      <iso:assert test="count(gn:svar[@id='8']) le 1">
        <value-of select="$intyg"/> får ha högst ett 'Synskärpa'
      </iso:assert>
      <iso:assert test="count(gn:svar[@id='32']) le 1">
        <value-of select="$intyg"/> får ha högst ett 'Övriga kommentarer'
      </iso:assert>
      <iso:assert test="count(gn:svar[@id='33']) ge 1 and count(gn:svar[@id='1']) le 16">
        <value-of select="$intyg"/> måste ha mellan 1 och 16 'Uppfyller krav för behörighet'
      </iso:assert>
      <iso:assert test="count(gn:svar[@id='45']) le 1">
        <value-of select="$intyg"/> får ha högst ett 'Lämplig att inneha behörighet med hänsyn till aktuella körningar och arbetsformer'
      </iso:assert>
      <iso:assert test="count(gn:svar[@id='34']) le 1">
        <value-of select="$intyg"/> får ha högst ett 'Bör undersökas av specialistläkare'
      </iso:assert>
  ...
  <iso:pattern id="q2">
    ...
    <iso:rule context="//gn:svar[@id='2']">
      <iso:assert test="count(gn:delsvar[@id=$delsvarId]) = 1">
  ...
  <iso:pattern id="q101">
    ...
    <iso:let name="svarId" value="101"/>
    <iso:let name="delsvarId" value="101.1"/>
  ...
  <iso:pattern id="q106">
    ...
    <iso:let name="svarId" value="106"/>
    <iso:let name="delsvarId_1" value="106.1"/>
    <iso:let name="delsvarId_2" value="106.2"/>
    ...
    <iso:rule context="//gn:delsvar[@id='@delsvarId_2']">
      <iso:extends rule="date"/>
    </iso:rule>
  ...
  <iso:pattern id="q108">
    ...
    <iso:let name="svarId" value="108"/>
    <iso:let name="delsvarId_1" value="108.1"/>
    <iso:let name="delsvarId_2" value="108.2"/>
  ...
  <iso:pattern id="q103">
    ...
    <iso:let name="svar103" value="'Proliferativ retinopati, genomgången laserbehandling av retinopati,
                                    signifikant makulaödem, annan ögonsjukdom eller ögonbottenfoto som ger misstanke
                                    om sådan ögonsjukdom (Svar)'"/>
    <iso:let name="svar103_1" value="'Proliferativ retinopati, genomgången laserbehandling av retinopati,
                                      signifikant makulaödem, annan ögonsjukdom eller ögonbottenfoto som ger misstanke
                                      om sådan ögonsjukdom (Delsvar)'"/>
  ...
  <iso:pattern id="q8">
    ...
    <iso:rule context="//gn:delsvar[@id='8.1']">
      <iso:assert test="matches(normalize-space(.), 'true|1|false|0'))">
        "<value-of select="@svar8_1"/>" måste ha ett svar av typen boolean
      </iso:assert>
    </iso:rule>
  ...
  <iso:pattern id="q32">
    ...
    <iso:rule context="//gn:delsvar[@id='32.1']">
      <iso:assert test="matches(normalize-space(.), 'true|1|false|0'))">
        "<value-of select="@svar32_1"/>" måste ha ett svar av typen boolean
      </iso:assert>
    </iso:rule>
  ...
  <iso:pattern id="q33">
    ...
    <iso:let name="svarId" value="33"/>
    <iso:let name="delsvarId" value="33.1"/>
  ...
  <iso:pattern id="q45">
    ...
    <iso:let name="svar45" value="'Egenkontroller av blodsocker (Svar)'"/>
    <iso:let name="svar45_1" value="'Egenkontroller av blodsocker (Delsvar)'"/>
  ...
  <iso:pattern id="q34">
    ...
    <iso:rule context="//gn:delsvar[@id='34.1']">
      ...
      <iso:assert test="string-length(normalize-space(text())) <= 71">
  ...
  <iso:pattern id="R1-1.1-45.1">
    ...
    <iso:rule context="//gn:delsvar[@id='1.1">
      <iso:assert test="matches(normalize-space(tp:cv/tp:code), '^IAV[1-8]$') and
                        count(../../gn:svar[@id='45']/gn:delsvar[@id='45.1']) = 1">
        Om "<value-of select="$svar1_1"/>" har något av värdena IAV1 - IAV8, måste även "<value-of select="$svar45_1"/>" besvaras.
      </iso:assert>
    </iso:rule>
  </iso:pattern>

  <iso:pattern id="R6-109.4-101.1-102.1-38.1-36.1-105.1-106.1-107.1-108.1">
    <iso:let name="svar109_4" value="'Insulinbehandling (delsvar)'"/>
    <iso:let name="svar101_1" value="'Förstår risker förknippade med hypoglykemi (Delsvar)'"/>
    <iso:let name="svar102_1" value="'Är väl förtrogen med symptomen på hypoglykemi (Delsvar)'"/>
    <iso:let name="svar38_1" value="'Saknar förmåga att känna varningstecken (Delsvar)'"/>
    ...
    <iso:rule context="//gn:svar[@id='109']">
      <iso:assert test="count(gn:delsvar[@id='109.4']) = 1 and
                        count(../gn:svar[@id='101']/gn:delsvar[@id='101.1']) = 1 and
                        count(../gn:svar[@id='102']/gn:delsvar[@id='102.2']) = 1 and
                        count(../gn:svar[@id='38']/gn:delsvar[@id='38.1']) = 1 and
                        count(../gn:svar[@id='36']/gn:delsvar[@id='36.1']) = 1 and
                        count(../gn:svar[@id='105']/gn:delsvar[@id='105.1']) = 1">
        ...
        "<value-of select="$svar36_1"/>" och
        "<value-of select="$svar105_1"/>" besvaras.
      </iso:assert>
    </iso:rule>
  </iso:pattern>
  ...
  <iso:pattern id="R12: 103.1-104.1-8">
    ...
    <iso:let name="delsvarId103_1" value="103.1"/>
    <iso:let name="delsvarId104_1" value="104.1"/>
    <iso:let name="svar103_1" value="'Proliferativ retinopati, genomgången laserbehandling av retinopati,
                                      signifikant makulaödem, annan ögonsjukdom eller ögonbottenfoto som ger misstanke
                                      om sådan ögonsjukdom (Delsvar)'"/>
    <iso:let name="svar104_1" value="'Ögonbottenfoto saknas (Delsvar)'"/>
  ...
  <iso:pattern id="R13, R14, R15: 1.1-8.1-8.2-8.4-8.5-8.6">
    ...
    <!--R13-->
    <iso:rule context="//gn:svar[@id='1']">
      <iso:assert test="(matches(normalize-space(gn:delsvar[@id=1.1]/tp:cv/tp:code), '^IAV1[1-7]$') and
                        abs(../gn:svar[@id=1]/gn:delsvar[@id='8.3']) lt 0.5) and
    ...
    <!--R14-->
    <iso:rule context="//gn:svar[@id='1']">
      <iso:assert test="(matches(normalize-space(gn:delsvar[@id=1.1]/tp:cv/tp:code), '^IAV1[1-9]$') and
                        abs(../gn:svar[@id=1]/gn:delsvar[@id='8.1']) lt 0.8 and
                        abs(../gn:svar[@id=1]/gn:delsvar[@id='8.2']) lt 0.8) and
                        count(../gn:svar[@id='8']/gn:delsvar[@id=8.4]) = 1 and
                        count(../gn:svar[@id='8']/gn:delsvar[@id=8.5]) = 1 and
                        count(../gn:svar[@id='8']/gn:delsvar[@id=8.6]) = 1">
    ...
    <iso:rule context="//gn:svar[@id='1']">
      <iso:assert test="(matches(normalize-space(gn:delsvar[@id=1.1]/tp:cv/tp:code), '^IAV1[1-9]$') and
                        abs(../gn:svar[@id=1]/gn:delsvar[@id='8.1']) lt 0.1 and
                        abs(../gn:svar[@id=1]/gn:delsvar[@id='8.2']) lt 0.1) and
                        count(../gn:svar[@id='8']/gn:delsvar[@id=8.4]) = 1 and
                        count(../gn:svar[@id='8']/gn:delsvar[@id=8.5]) = 1 and
                        count(../gn:svar[@id='8']/gn:delsvar[@id=8.6]) = 1">
  ...
  <iso:pattern id="R17-109.3-101.1-102.1-38.1-36.1-105.1-106.1-107.1-108.1">
    ...
    <iso:rule context="//gn:svar[@id=109]">
      <iso:assert test="count(gn:delsvar[@id='109.3']) = 1 and
                        count(../gn:svar[@id='101']/gn:delsvar[@id='101.1']) = 1 and
                        count(../gn:svar[@id='102']/gn:delsvar[@id='102.2']) = 1 and
                        count(../gn:svar[@id='38']/gn:delsvar[@id='38.1']) = 1 and
                        count(../gn:svar[@id='36']/gn:delsvar[@id='36.1']) = 1 and
