...
import se.inera.certificate.modules.support.api.builder.CertificateHolderBuilder;
...
public class ModelConverterTest {
    ...
    public void testToCertificateMetaTypeConversion() {
        ...
        CertificateHolder certificate = createCertificate();
    ...
    private CertificateHolder createCertificate() {
        return new CertificateHolderBuilder("112233")
