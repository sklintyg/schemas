...
package se.inera.webcert.receivemedicalcertificateanswerresponder.v1;
    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AnswerFromFkType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final AnswerFromFkType that = ((AnswerFromFkType) object);
        {
