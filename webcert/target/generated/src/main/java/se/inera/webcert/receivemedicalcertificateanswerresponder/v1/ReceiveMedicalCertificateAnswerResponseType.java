    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ReceiveMedicalCertificateAnswerResponseType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ReceiveMedicalCertificateAnswerResponseType that = ((ReceiveMedicalCertificateAnswerResponseType) object);
        {
