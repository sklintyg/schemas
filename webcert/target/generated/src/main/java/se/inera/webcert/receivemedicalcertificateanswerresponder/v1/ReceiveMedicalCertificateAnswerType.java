    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ReceiveMedicalCertificateAnswerType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ReceiveMedicalCertificateAnswerType that = ((ReceiveMedicalCertificateAnswerType) object);
        {
            AnswerFromFkType lhsAnswer;
            lhsAnswer = this.getAnswer();
            AnswerFromFkType rhsAnswer;
