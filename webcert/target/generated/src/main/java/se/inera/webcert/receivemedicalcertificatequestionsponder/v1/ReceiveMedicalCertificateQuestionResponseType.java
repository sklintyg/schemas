    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ReceiveMedicalCertificateQuestionResponseType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ReceiveMedicalCertificateQuestionResponseType that = ((ReceiveMedicalCertificateQuestionResponseType) object);
        {
