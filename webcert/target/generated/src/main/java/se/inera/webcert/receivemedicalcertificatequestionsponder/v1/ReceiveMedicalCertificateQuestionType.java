    ...
    implements Equals, HashCode, ToString
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            QuestionFromFkType theQuestion;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ReceiveMedicalCertificateQuestionType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ReceiveMedicalCertificateQuestionType that = ((ReceiveMedicalCertificateQuestionType) object);
        {
            QuestionFromFkType lhsQuestion;
            lhsQuestion = this.getQuestion();
            QuestionFromFkType rhsQuestion;
