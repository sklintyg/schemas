...
/**
 * <p>Java class for AnswerToFkType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AnswerToFkType">
 *   &lt;complexContent>
...
@XmlType(name = "AnswerToFkType", propOrder = {
    "vardReferensId",
    "fkReferensId",
    "amne",
    "fraga",
    ...
    implements Equals, HashCode, ToString
{
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            String theVardReferensId;
            theVardReferensId = this.getVardReferensId();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "vardReferensId", theVardReferensId), currentHashCode, theVardReferensId);
        }
        {
        ...
        {
            InnehallType theSvar;
            theSvar = this.getSvar();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "svar", theSvar), currentHashCode, theSvar);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AnswerToFkType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final AnswerToFkType that = ((AnswerToFkType) object);
        {
            String lhsVardReferensId;
            lhsVardReferensId = this.getVardReferensId();
            String rhsVardReferensId;
            rhsVardReferensId = that.getVardReferensId();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "vardReferensId", lhsVardReferensId), LocatorUtils.property(thatLocator, "vardReferensId", rhsVardReferensId), lhsVardReferensId, rhsVardReferensId)) {
                return false;
            }
        }
        {
        ...
        {
            InnehallType lhsSvar;
            lhsSvar = this.getSvar();
            InnehallType rhsSvar;
            rhsSvar = that.getSvar();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "svar", lhsSvar), LocatorUtils.property(thatLocator, "svar", rhsSvar), lhsSvar, rhsSvar)) {
                return false;
            }
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            String theVardReferensId;
            theVardReferensId = this.getVardReferensId();
            strategy.appendField(locator, this, "vardReferensId", buffer, theVardReferensId);
        }
        {
            String theFkReferensId;
            theFkReferensId = this.getFkReferensId();
        ...
        }
        {
            InnehallType theSvar;
            theSvar = this.getSvar();
            strategy.appendField(locator, this, "svar", buffer, theSvar);
        }
        {
            LocalDateTime theAvsantTidpunkt;
            theAvsantTidpunkt = this.getAvsantTidpunkt();
