...
/**
 * <p>Java class for QuestionToFkType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="QuestionToFkType">
 *   &lt;complexContent>
...
@XmlType(name = "QuestionToFkType", propOrder = {
    "vardReferensId",
    "amne",
    "fraga",
    "avsantTidpunkt",
    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof QuestionToFkType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final QuestionToFkType that = ((QuestionToFkType) object);
        {
