...
/**
 * <p>Java class for SendMedicalCertificateQuestionResponseType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="SendMedicalCertificateQuestionResponseType">
 *   &lt;complexContent>
...
@XmlType(name = "SendMedicalCertificateQuestionResponseType", propOrder = {
    "result",
    "any"
})
public class SendMedicalCertificateQuestionResponseType
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof SendMedicalCertificateQuestionResponseType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final SendMedicalCertificateQuestionResponseType that = ((SendMedicalCertificateQuestionResponseType) object);
        {
            ResultOfCall lhsResult;
            lhsResult = this.getResult();
            ResultOfCall rhsResult;
